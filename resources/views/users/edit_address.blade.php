            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 account_sec my_account_sec">
                        ...
                        <div class="col-xs-12 no-padding">
                            <div id="billingAddress" class="well col-xs-12 padding-md no-margin no-padding">
                                <div class="col-xs-10 col-sm-4 no-padding">
                                    <h4 class="normal_header">Edit Address</h4>
                                </div> <!-- col-xs-4 ends -->
                        ...
                        <form action="{{  route('users.address.edit.post', $address->id) }}" method="POST" class="bueno_form billing_address col-xs-12 margintb-md">
                            {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group bueno_form_group">
                                            <input type="text" class="form-control bueno_inputtext black" name="address_name" id="title" placeholder="Home, Office etc" value="{{ old('address_name') ? old('address_name') : $address->address_name }}">
                                        </div> <!-- bueno_form_group ends -->
                                        <div class="form-group bueno_form_group">
                                            <textarea type="text" class="form-control bueno_inputtext black" placeholder="Address" name="address">{{ old('address') ? old('address') : $address->address }}</textarea>
                                        </div> <!-- bueno_form_group ends -->
                                    </div> <!-- col-xs-12 ends -->
                                </div> <!-- row ends -->
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group bueno_form_group">
                                            <label class="bueno_select no_caret form">
                                                <input type="number" class="form-control bueno_inputtext black" id="pincode" placeholder="Pincode" name="pincode" value="{{ old('pincode') ? old('pincode') : $address->pincode }}">
                                            </label> <!-- bueno_select ends -->
                                        </div> <!-- bueno_form_group ends -->
                                    </div> <!-- col-xs-12 ends -->
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group bueno_form_group">
                                            <a href="{{ route('users.address.edit.delete', $address->id ) }}" class="btn form btn-primary full_width delete_address">Delete</a>
                                        </div> <!-- bueno_form_group ends -->
                                    </div> <!-- col-xs-12 ends -->
                                </div> <!-- row ends -->
