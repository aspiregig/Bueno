  ...
  <div id="content">
      <div class="menubar">
        ...
        <div class="options pull-right">
          <a href="{{URL::route('admin.gm.export')}}"><i class="fa fa-download"></i> Download</a>
        </div>
      </div>
          ...
          <table id="datatable-example">
                      <thead>
                          <tr>
                              ...
                              <th tabindex="0" rowspan="1" colspan="1">Item Name
                              </th>
                              <th tabindex="0" rowspan="1" colspan="1">Quantity
                              </th>
                              <th tabindex="0" rowspan="1" colspan="1">MRP Value
                              </th>
                              <th tabindex="0" rowspan="1" colspan="1">Tax Value
                              </th>
                              <th tabindex="0" rowspan="1" colspan="1">Invoice Value
                              </th>
                              <th tabindex="0" rowspan="1" colspan="1">Discount Value
                              </th>
                              <th tabindex="0" rowspan="1" colspan="1">COGS
                              </th>
                              <th tabindex="0" rowspan="1" colspan="1">Gross Profit(Nt Tax)
                              </th>
                          </tr>
                      </thead>
                      <tbody>
