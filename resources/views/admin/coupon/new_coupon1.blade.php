      ...
      <div class="content-wrapper">
        <form id="new-product" class="form-horizontal" method="post" action="#" role="form">
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 col-md-2 control-label">Coupon Code Generation</label>
            ...
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 col-md-2 control-label">Discount as Percentage</label>
              <div class="col-sm-10 col-md-8">
                <select class="form-control" data-smart-select>
                  <option>No</option>
                  <option>Yes</option>
            ...
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 col-md-2 control-label">Discount as Amount</label>
              <div class="col-sm-10 col-md-8">
                <select class="form-control" data-smart-select>
                  <option>No</option>
                  <option>Yes</option>
            ...
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 col-md-2 control-label">Minimum Order Amount Limit</label>
              <div class="col-sm-10 col-md-8">
                <select class="form-control" data-smart-select>
                  <option>No</option>
                  <option>Yes</option>
            ...
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 col-md-2 control-label">Minimum Order Quantity Limit</label>
              <div class="col-sm-10 col-md-8">
                <select class="form-control" data-smart-select>
                  <option>No</option>
                  <option>Yes</option>
            ...
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 col-md-2 control-label">Maximum Discount Amount</label>
              <div class="col-sm-10 col-md-8">
                <select class="form-control" data-smart-select>
                  <option>No</option>
                  <option>Yes</option>
            ...
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 col-md-2 control-label">Category Specific</label>
              <div class="col-sm-10 col-md-8">
                <select class="form-control" data-smart-select>
                  <option>No</option>
                  <option>Yes</option>
            ...
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 col-md-2 control-label">Must Have in Cart Condition</label>
              <div class="col-sm-10 col-md-8">
                <select class="form-control" data-smart-select>
                  <option>No</option>
                  <option>Yes</option>
            ...
            <div class="form-group">
                        ...
                        <div class="col-sm-10 col-md-8">
                            <div class="has-feedback">
                                <select name="data[Group][Group][]" multiple="multiple" class="GroupGroup form-control">
                                <option value="1966">Gurgoan</option>
                                <option value="1513">Noida</option>
                                <option value="1705">Delhi</option>
                                </select>
                            </div>
                        </div>
            </div>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                        ...
                        <div class="col-sm-10 col-md-8">
                            <div class="has-feedback">
                                <select name="data[Group][Group][]" multiple="multiple" class="GroupGroup form-control">
                                <option value="1513">Paytm</option>
                                <option value="1705">Mobikwik</option>
                                <option value="391">COD</option>
                                <option value="1966">PayU money</option>
                                </select>
                            </div>
                        </div>
                </div> 
              ...
              <div class="input-group input-group-sm ">
                ...
                <input name="start" type="text" class="form-control datepicker" placeholder="02/27/2015" style="width: 300px;"/>
              </div>  
            </div>  
            <div class="form-group">
              ...
              <div class="input-group input-group-sm">
                ...
                <input name="end" type="text" class="form-control datepicker" placeholder="02/27/2015" style="width: 300px;" />
            </div>
            </div>  
            <div class="form-group">
                        <label class="col-sm-2 col-md-2 control-label">For Nth Order</label>
                        <div class="col-sm-10 col-md-8">
                            <div class="has-feedback">
                                <select name="data[Group][Group][]" multiple="multiple" class="GroupGroup form-control">
                                <option value="1513">1</option>
                                <option value="1705">2</option>
                                <option value="391">3</option>
                                <option value="1513">4</option>
                                <option value="1705">5</option>
                                <option value="391">6</option>
                                <option value="1513">7</option>
                                <option value="1705">8</option>
                                <option value="391">9</option>
                                <option value="1513">10</option>
                                <option value="1705">11</option>
            ...
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10 col-md-offset-2 col-md-10">
                  <div class="checkbox">
                    <label>
                        <input type="checkbox" name="product[send_marketing]" /> Automatically Apply to Nth Order
                    </label>
                  </div>
              </div>
            </div>
            ...
            <div class="form-group form-actions">
              <div class="col-sm-offset-2 col-sm-10 col-md-offset-2 col-md-10">
                <a href="/coupons" class="btn btn-default">Cancel</a>
                  <a href="/coupons" class="btn btn-success">Create Coupon </a>
              </div>
            </div>
        </form>
      </div>
