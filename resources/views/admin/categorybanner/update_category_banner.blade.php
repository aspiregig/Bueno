        ...
        <form id="new-product" class="form-horizontal" method="post" action="#" role="form">
                  ...
                  <div class="pic">
                    <img src="images/products/14.jpg" class="img-responsive" />
                          ...
                          <div class="control-group">
                            ...
                            <input id="post_featured_image" name="" type="file">
                        </div>
                          <div class="control-group">
                                <label for="post_images_attributes_0_alt">Alt:</label>
                                <input class="form-control" name="alt_text" value="{{$banner->alt_text}}" size="30" style="width: 50%;" type="text" />
                            </div>
            ...
            <div class="form-group form-actions">
              <div class="col-sm-offset-2 col-sm-10 col-md-offset-2 col-md-10">
                ...
                <a href="{{URL::route('admin.delete_banner',$banner->id)}}" class="btn btn-danger">Delete</a>
              </div>
            </div>
        </form>
      </div>
