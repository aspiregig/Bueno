<script type="text/html" id="hot-deals-listing-template">
            ...
            <div class="listing_footer">
                <div class="sec_table">
                    <div class="sec_table_row">
                        ...
                        <a href="" class="btn btn-primary action add_to_cart" data-id="<%= item.id %>" data-token="{{ csrf_token() }}" data-url="{{ route('users.cart.post') }}">Add to Cart</a>
